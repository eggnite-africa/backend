...
export class InitialMigration1581349338694 implements MigrationInterface {
    name = 'InitialMigration1581349338694'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "content" text NOT NULL, "productId" integer, "parentId" integer, "userId" integer NOT NULL, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TYPE "profile_sex_enum" AS ENUM('MALE', 'FEMALE')`, undefined);
        await queryRunner.query(`CREATE TYPE "profile_occupation_enum" AS ENUM('STUDENT', 'DEV', 'ENTREPRENEUR')`, undefined);
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "profilePicture" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "sex" "profile_sex_enum" NOT NULL, "birthDate" TIMESTAMP, "occupation" "profile_occupation_enum" NOT NULL DEFAULT 'STUDENT', "university" character varying, "bio" character varying, "socialLinks" text, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TYPE "user_type_enum" AS ENUM('ADMIN', 'USER', 'MAKER')`, undefined);
        await queryRunner.query(`CREATE TABLE "user" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "passwordResetToken" character varying DEFAULT null, "passwordTokenExpiration" bigint DEFAULT null, "profileId" integer NOT NULL, "type" "user_type_enum" NOT NULL DEFAULT 'USER', CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_9466682df91534dd95e4dbaa61" UNIQUE ("profileId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" text NOT NULL, "tagline" character varying NOT NULL, "description" text, "linksId" integer NOT NULL, "media" json NOT NULL, "posterId" integer, CONSTRAINT "UQ_22cc43e9a74d7498546e9a63e77" UNIQUE ("name"), CONSTRAINT "REL_295f2a324bdbd90a9d57b7dda3" UNIQUE ("linksId"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP TYPE "profile_sex_enum"`, undefined);
