...
export class InitialMigration1581546176387 implements MigrationInterface {
    name = 'InitialMigration1581546176387'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "profilePicture" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "gender" "profile_gender_enum" NOT NULL, "birthDate" TIMESTAMP, "occupation" "profile_occupation_enum" NOT NULL DEFAULT 'STUDENT', "university" character varying, "bio" character varying, "socialLinks" text, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" text NOT NULL, "tagline" character varying NOT NULL, "description" character varying NOT NULL, "linksId" integer NOT NULL, "media" json NOT NULL, "posterId" integer, CONSTRAINT "UQ_22cc43e9a74d7498546e9a63e77" UNIQUE ("name"), CONSTRAINT "REL_295f2a324bdbd90a9d57b7dda3" UNIQUE ("linksId"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`, undefined);
